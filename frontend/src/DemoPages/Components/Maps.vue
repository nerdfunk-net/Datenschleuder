            ...
            <b-card-body>
              <div id="maps-root">
                ...
                <div v-if="mapLoaded" class="alert alert-success mt-3">
                  ...
                  <p class="mb-0">
                    Google Maps is successfully configured and ready to use.
                  </p>
                </div>
              </div>
            </b-card-body>
        ...
        <b-col md="6">
          <b-card class="main-card mb-4">
            <b-card-header>
              ...
              >
                <i
                  class="header-icon lnr-leaf icon-gradient bg-happy-green"
                ></i>
        ...
        <b-col md="6">
          <b-card class="main-card mb-4">
            <b-card-header>
              ...
              >
                <i
                  class="header-icon lnr-earth icon-gradient bg-google-blue"
                ></i>
                Google Maps
              </div>
            </b-card-header>
            <b-card-body>
              ...
              <ol class="ps-3 mb-4">
                ...
                <li>
                  Install: <code>npm install @googlemaps/js-api-loader</code>
                </li>
              </ol>
        ...
        <b-col md="12">
          <b-card class="main-card mb-4">
            <b-card-header>
              ...
              >
                <i
                  class="header-icon lnr-chart-bars icon-gradient bg-plum-plate"
                ></i>
                ...
                <table class="table table-borderless">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center">
                        <span class="badge bg-warning">Pay per use</span>
                      </td>
                    </tr>
                    <tr>
...
export default {
  ...
  data() {
    return {
      heading: "Maps",
      subheading:
        "Implement Google Maps or other mapping solutions in your applications.",
