          ...
          <div class="bg-white bg-opacity-10 rounded-3 p-4">
            <div class="d-flex flex-column gap-3 text-white-50">
              <div class="d-flex align-items-start">
                <i
                  class="pe-7s-mail text-warning me-3 mt-1"
              ...
              <div class="d-flex align-items-start">
                <i
                  class="pe-7s-shield text-warning me-3 mt-1"
                  style="font-size: 1.2rem"
                ></i>
                <div>
                  <div class="text-white fw-medium mb-1">
    ...
    >
      <div class="w-100" style="max-width: 400px">
        ...
        <div class="d-lg-none text-center mb-5">
          <div
            class="d-inline-flex align-items-center justify-content-center bg-warning rounded-3 p-3 mb-3"
          >
        ...
        <form>
          ...
          <div class="d-grid mb-4">
            <b-button variant="warning" size="lg" class="fw-medium py-3">
        ...
        <div class="mt-5 p-4 bg-light rounded-3">
          <div class="d-flex align-items-start">
            <i
              class="pe-7s-info text-warning me-3 mt-1"
              style="font-size: 1.2rem"
            ></i>
            <div>
