...
from models.auth import LoginResponse, OIDCCallbackRequest, OIDCProvidersResponse, OIDCProvider
...
@router.post("/{provider_id}/callback", response_model=LoginResponse)
