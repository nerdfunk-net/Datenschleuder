<template>
  <div>
          ...
          <div class="mb-4">
            ...
            <div class="text-center">
              <small class="text-muted">
                ...
                {{ Math.min(limitedPage * largePerPage, largeRows) }} of
                {{ largeRows }} items
              </small>
            </div>
          </div>
    ...
    <b-card
      title="Interactive Pagination with Sample Data"
      class="main-card mb-3"
    >
      <div class="mb-3">
        <b-row>
          <b-col sm="6">
...
export default {
  ...
  data() {
    return {
      heading: "Pagination",
      subheading:
        "Bootstrap-Vue-Next pagination components for navigating through pages of content.",
  ...
  computed: {
    ...
    endIndex() {
      return Math.min(
        this.startIndex + this.interactivePerPage,
