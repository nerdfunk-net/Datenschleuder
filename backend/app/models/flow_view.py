...
class FlowView(Base):
    ...
    name = Column(String, nullable=False, index=True)  # e.g., "Source View", "Destination View"
    description = Column(String, nullable=True)  # Optional description
    visible_columns = Column(Text, nullable=False)  # JSON array of column names
    column_widths = Column(Text, nullable=True)  # JSON object of column widths {column_key: width_px}
