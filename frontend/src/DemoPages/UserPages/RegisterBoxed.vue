<template>
  <div class="min-vh-100 d-flex">
    ...
    <div
      class="d-none d-lg-flex col-lg-5 bg-dark position-relative overflow-hidden"
    >
      <div
        ...
        <div class="mt-4">
          <div class="d-flex flex-column gap-3 text-white-50">
            <div class="d-flex align-items-center">
              <i
                class="pe-7s-check text-success me-3"
    ...
    <div
      class="col-12 col-lg-7 bg-white d-flex align-items-center justify-content-center p-4"
    >
      <div class="w-100" style="max-width: 480px">
        <!-- Mobile Logo -->
        <div class="d-lg-none text-center mb-5">
          <div
            class="d-inline-flex align-items-center justify-content-center bg-success rounded-3 p-3 mb-3"
          >
        ...
        <form>
          ...
          <div class="d-grid mb-4">
            <b-button variant="success" size="lg" class="fw-medium py-3">
              Create Account
            </b-button>
          </div>
        ...
        <div class="text-center mt-5">
          <p class="text-secondary small mb-0">
            © 2025 ArchitectUI. All rights reserved.
          </p>
        </div>
      </div>
    </div>
