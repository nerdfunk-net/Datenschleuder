...
echo "🔒 Deploying Datenschleuder All-in-One in Air-Gapped Environment"
echo "=============================================================="
...
COMPRESSED_FILE="docs/docker/airgap-artifacts/${IMAGE_NAME}-${IMAGE_TAG}.tar.gz"
UNCOMPRESSED_FILE="docs/docker/airgap-artifacts/${IMAGE_NAME}-${IMAGE_TAG}.tar"
...
echo ""
echo "🚀 Starting Datenschleuder container..."
...
docker run -d \
    ...
    -p 3000:3000 \
    -p 8000:8000 \
    -v datenschleuder-data:/app/data \
    "$FULL_IMAGE_NAME"
...
if docker ps | grep -q "$CONTAINER_NAME"; then
    ...
    echo ""
    echo "📂 Data Volume:"
    echo "   Name: datenschleuder-data"
    echo "   Mount: /app/data"
    echo "   Backup: docker run --rm -v datenschleuder-data:/data -v \$(pwd):/backup alpine tar czf /backup/datenschleuder-backup.tar.gz /data"
...
echo ""
echo "🎉 Datenschleuder All-in-One Deployment Complete!"
echo "==============================================="
