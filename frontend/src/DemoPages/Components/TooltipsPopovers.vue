    ...
    <div class="main-card mb-3 card">
      <div class="card-body">
        ...
        <div class="text-center">
          <b-button id="tooltip-top" variant="primary" class="me-2 mb-2">
            Tooltip on top
          </b-button>
          <b-tooltip target="tooltip-top" placement="top" triggers="hover">
            Tooltip on top
          </b-tooltip>

          <b-button id="tooltip-right" variant="primary" class="me-2 mb-2">
            Tooltip on right
          </b-button>
          <b-tooltip target="tooltip-right" placement="right" triggers="hover">
            Tooltip on right
          </b-tooltip>

          <b-button id="tooltip-bottom" variant="primary" class="me-2 mb-2">
            Tooltip on bottom
          </b-button>
          <b-tooltip
          ...
          <b-button id="tooltip-left" variant="primary" class="me-2 mb-2">
            Tooltip on left
          </b-button>
          <b-tooltip target="tooltip-left" placement="left" triggers="hover">
            Tooltip on left
          </b-tooltip>
        </div>
        ...
        <div class="text-center">
          ...
          <div class="d-inline-block position-relative me-2 mb-2">
            <button class="btn btn-success" @click="toggleClickTooltip">
              Click for Tooltip
            </button>
            <div
              v-if="showClickTooltip"
              class="custom-tooltip tooltip-top"
              @click.stop
            >
          ...
          <div class="d-inline-block position-relative me-2 mb-2">
            <button
              ...
              @focus="showFocusTooltip = true"
              @blur="showFocusTooltip = false"
            >
              Focus for Tooltip
            </button>
            <div
              v-if="showFocusTooltip"
              class="custom-tooltip tooltip-bottom"
              @click.stop
            >
          ...
          <b-button id="tooltip-hover-only" variant="info" class="me-2 mb-2">
            Hover for Tooltip
          </b-button>
          <b-tooltip
            target="tooltip-hover-only"
            placement="bottom"
            triggers="hover"
          >
    ...
    <div class="main-card mb-3 card">
      <div class="card-body">
        ...
        <div class="text-center mb-4">
          ...
          <div class="d-inline-block position-relative me-2 mb-2">
            <button class="btn btn-success" @click="toggleBasicPopover">
              Click for Popover
            </button>
            <div
              v-if="showBasicPopover"
            ...
            <div
              ...
              @click="showBasicPopover = false"
            ></div>
          </div>

          <!-- CLICK-ONLY HTML POPOVER (Custom Implementation) -->
          <div class="d-inline-block position-relative me-2 mb-2">
            <button class="btn btn-info" @click="toggleHtmlPopover">
              Click for HTML Popover
            </button>
            <div
              v-if="showHtmlPopover"
          ...
          >
            ...
            <div class="d-inline-block position-relative">
              <button
                ...
                @click="togglePlacementPopover(placement)"
              >
                Click: {{ placement }}
              </button>
              <div
        ...
        <div class="text-center">
          ...
          <div class="d-inline-block position-relative me-2 mb-2">
            <button
              ...
              @focus="showFocusPopover = true"
              @blur="showFocusPopover = false"
            >
              Focus for Popover
            </button>
            <div
              v-if="showFocusPopover"
          ...
          <!-- CLICK-ONLY POPOVER (Custom Implementation) -->
          <div class="d-inline-block position-relative me-2 mb-2">
            <button class="btn btn-info" @click="toggleClickPopover">
              Click for Popover
            </button>
            <div
              v-if="showClickPopover"
              class="custom-popover popover-right"
              @click.stop
            >
          ...
          >
            This popover is controlled <strong>manually via JavaScript</strong>.
            Click the button to toggle it on/off.
          </b-popover>
        </div>
          ...
          <div class="col-md-6">
            <div class="alert alert-success">
              ...
              <ul class="mb-0 small">
                ...
                <li>
                  <strong>Click tooltips:</strong> Show/hide on button click
                </li>
                <li>
                  <strong>Focus tooltips:</strong> Show when element gets focus
                </li>
              </ul>
            </div>
          </div>
          <div class="col-md-6">
            <div class="alert alert-primary">
              ...
              <ul class="mb-0 small">
                ...
                <li>
                  <strong>Hover popovers:</strong> Show on hover, hide when
                  mouse leaves
                </li>
                <li>
                  <strong>Focus popovers:</strong> Show on focus, hide when
                  focus lost
                </li>
                <li>
                  <strong>Manual popovers:</strong> Controlled via JavaScript
                  toggle
                </li>
              </ul>
            </div>
        ...
        <div class="alert alert-info mt-3">
          ...
          <ul class="mb-0">
            <li>
              ...
              Best for tooltips and quick info
            </li>
            <li>
              <strong>Click behavior:</strong> <code>triggers="click"</code> -
              Good for interactive content and forms
            </li>
            <li>
              <strong>Focus behavior:</strong> <code>triggers="focus"</code> -
              Great for accessibility and keyboard navigation
            </li>
            <li>
              <strong>Manual control:</strong>
              <code>triggers="manual" :show="variable"</code> - For complex
              interactions
            </li>
          </ul>
        </div>
